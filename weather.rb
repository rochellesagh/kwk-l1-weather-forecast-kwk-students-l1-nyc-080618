...
#   weather_hash =  {"New York"=> "Partly Cloudy"=> 66.3 } 
#   weather_hash.each do |city, description, temperature_farenheit|
#     puts "City #{city}, Description #{description}, Temperature_farenheit #{temperature_farenheit}"
# end
# return city 
  weather[:city]
end 
...
# 3. Using the methods above and string interpolation, update the method below so that it returns a string that describes the current weather - for example: "The weather in New York is Partly Cloudy. The temperature is 66.3 degrees Farenheit." HINT: the method should RETURN the string, not print it to the terminal. 
